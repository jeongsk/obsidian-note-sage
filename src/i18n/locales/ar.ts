...
export const ar: TranslationKeys = {
	...
	settings: {
		...
		skills: {
			...
			instructionsDesc: 'التعليمات التي يجب على Claude اتباعها عند تنفيذ هذه Skill',
			instructionsPlaceholder: 'صف كيف يجب أن تعمل هذه Skill والمهام المطلوب تنفيذها...',
			examplesLabel: 'الأمثلة',
			examplesDesc: 'أمثلة استخدام توضح هذه Skill',
			examplesPlaceholder: 'اكتب أمثلة للمدخلات والمخرجات المتوقعة...',
			preview: 'معاينة',
			...
			deleteTitle: 'حذف Skill',
			deleteConfirmMessage: 'هل أنت متأكد من حذف {name}؟',
			deleteUndoHint: 'يمكنك التراجع عن هذا الإجراء خلال 10 ثوانٍ.',
			deleteSuccess: 'تم حذف Skill "{name}".',
			deleteError: 'فشل حذف Skill: {error}',
			undo: 'تراجع',
			restoreSuccess: 'تم استعادة Skill.',
			restoreError: 'فشل استعادة Skill.',
			// AI Validation
