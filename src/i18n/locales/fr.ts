...
export const fr: TranslationKeys = {
	...
	settings: {
		...
		mcp: {
			...
			statusPending: 'Se connecte au démarrage du chat',
		...
		skills: {
			...
			instructionsDesc: 'Instructions que Claude doit suivre lors de l\'exécution de cette Skill',
			instructionsPlaceholder: 'Décrivez comment cette Skill doit fonctionner et les tâches à effectuer...',
			examplesLabel: 'Exemples',
			examplesDesc: 'Exemples d\'utilisation démontrant cette Skill',
			examplesPlaceholder: 'Écrivez des exemples d\'entrées et de sorties attendues...',
			preview: 'Aperçu',
			...
			deleteTitle: 'Supprimer la Skill',
			deleteConfirmMessage: 'Êtes-vous sûr de vouloir supprimer {name} ?',
			deleteUndoHint: 'Vous pouvez annuler cette action dans les 10 secondes.',
			deleteSuccess: 'La Skill "{name}" a été supprimée.',
			deleteError: 'Échec de la suppression de la Skill : {error}',
			undo: 'Annuler',
			restoreSuccess: 'La Skill a été restaurée.',
			restoreError: 'Échec de la restauration de la Skill.',
			// AI Validation
			...
			// Edit Modal
			editTitle: 'Modifier Skill',
			contentLabel: 'Contenu',
			contentDesc: 'Corps markdown complet (édition libre)',
			contentPlaceholder: '# skill-name\n\n## Instructions\n\n...',
			updateSuccess: 'Skill mis à jour avec succès',
			updateError: 'Erreur lors de la mise à jour du skill',
			skillsCount: '{count} Skills',
			activeCount: '{active} actif',
			// Documentation link
			docsLink: 'Voir la documentation officielle',
		},
