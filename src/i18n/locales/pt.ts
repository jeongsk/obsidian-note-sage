...
export const pt: TranslationKeys = {
	...
	settings: {
		...
		customQuickActions: {
			title: 'Ações rápidas personalizadas',
			add: 'Adicionar ação rápida personalizada',
			name: 'Nome',
			namePlaceholder: 'ex. Revisão de código',
			prompt: 'Prompt',
			promptPlaceholder: 'Digite o prompt a enviar...',
			delete: 'Excluir',
			deleteConfirm: 'Tem certeza de que deseja excluir "{name}"?',
			moveUp: 'Mover para cima',
			moveDown: 'Mover para baixo',
			empty: 'Nenhuma ação rápida personalizada ainda. Clique em "Adicionar" para criar uma.',
			noActions: 'Sem ações rápidas personalizadas',
			noActionsGuide: 'Clique no botão abaixo para criar uma nova ação rápida.',
			untitled: 'Sem título',
		},
		...
		mcp: {
			...
			statusPending: 'Conecta ao iniciar o chat',
		...
		skills: {
			...
			deleteConfirmMessage: 'Tem certeza de que deseja excluir {name}?',
			deleteUndoHint: 'Você pode desfazer esta ação em 10 segundos.',
			deleteSuccess: 'Skill "{name}" foi excluída.',
			deleteError: 'Falha ao excluir Skill: {error}',
			undo: 'Desfazer',
			restoreSuccess: 'Skill foi restaurada.',
			restoreError: 'Falha ao restaurar Skill.',
			// AI Validation
			...
			// Documentation link
			docsLink: 'Ver documentação oficial',
		},
