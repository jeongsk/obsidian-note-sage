...
export const es: TranslationKeys = {
	...
	settings: {
		...
		mcp: {
			...
			statusPending: 'Se conecta al iniciar el chat',
		...
		skills: {
			...
			createAIWizard: 'Crear con IA',
			aiWizardDesc: 'Describe lo que quieres que haga tu Skill y la IA lo generará por ti.',
			aiPromptLabel: 'Describe tu Skill',
			aiPromptDesc: 'Explica lo que debe hacer este Skill en lenguaje natural',
			aiPromptPlaceholder: 'Ej: Un skill que ayuda a formatear tablas markdown con alineación correcta...',
			generateBtn: 'Generar',
			generating: 'Generando Skill...',
			invalidName: 'Nombre de Skill inválido',
			...
			instructionsDesc: 'Instrucciones que Claude debe seguir al ejecutar esta Skill',
			instructionsPlaceholder: 'Describa cómo debe funcionar esta Skill y qué tareas realizar...',
			examplesLabel: 'Ejemplos',
			examplesDesc: 'Ejemplos de uso que demuestran esta Skill',
			examplesPlaceholder: 'Escriba ejemplos de entradas y salidas esperadas...',
			...
			deleteUndoHint: 'Puede deshacer esta acción en 10 segundos.',
			deleteSuccess: 'Skill "{name}" ha sido eliminada.',
			deleteError: 'Error al eliminar Skill: {error}',
			undo: 'Deshacer',
			restoreSuccess: 'Skill ha sido restaurada.',
			restoreError: 'Error al restaurar Skill.',
			// AI Validation
			validationFailed: 'La validación falló después de {max} intentos. Por favor, revise y edite el contenido manualmente.',
			validationErrors: 'El contenido tiene errores de validación:\n{errors}',
			retrying: 'Corrigiendo problemas... (intento {attempt}/{max})',
			noContentError: 'No hay contenido generado. Por favor, haga clic en "Generar" primero.',
			// Edit Modal
			editTitle: 'Editar Skill',
			contentLabel: 'Contenido',
			contentDesc: 'Cuerpo completo en markdown (edición libre)',
			contentPlaceholder: '# skill-name\n\n## Instructions\n\n...',
			updateSuccess: 'Skill actualizado correctamente',
			updateError: 'Error al actualizar skill',
			skillsCount: '{count} Skills',
			activeCount: '{active} activo',
			// Documentation link
			docsLink: 'Ver documentación oficial',
		},
