...
export const de: TranslationKeys = {
	...
	settings: {
		...
		skills: {
			...
			instructionsDesc: 'Anweisungen, die Claude bei der Ausführung dieser Skill befolgen soll',
			instructionsPlaceholder: 'Beschreiben Sie, wie diese Skill funktionieren soll und welche Aufgaben ausgeführt werden sollen...',
			examplesLabel: 'Beispiele',
			examplesDesc: 'Verwendungsbeispiele, die diese Skill demonstrieren',
			examplesPlaceholder: 'Schreiben Sie Beispiele für Eingaben und erwartete Ausgaben...',
			preview: 'Vorschau',
			...
			deleteConfirmMessage: 'Sind Sie sicher, dass Sie {name} löschen möchten?',
			deleteUndoHint: 'Sie können diese Aktion innerhalb von 10 Sekunden rückgängig machen.',
			deleteSuccess: 'Skill "{name}" wurde gelöscht.',
			deleteError: 'Skill konnte nicht gelöscht werden: {error}',
			undo: 'Rückgängig',
			restoreSuccess: 'Skill wurde wiederhergestellt.',
			restoreError: 'Skill konnte nicht wiederhergestellt werden.',
			// AI Validation
