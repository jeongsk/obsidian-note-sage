...
- **MCPサーバー統合**：外部ツールとリソースをAIエージェントに接続
- **多言語UI**：11言語対応（日本語、英語、韓国語、中国語、ドイツ語、フランス語、スペイン語、ポルトガル語、ロシア語、ヒンディー語、アラビア語）
...
MCP（Model Context Protocol）サーバーを接続してAIエージェントの機能を拡張できます。

| 設定 | 説明 |
|------|------|
| サーバー追加 | stdio、SSE、HTTPタイプのMCPサーバーを接続 |
| サーバー有効化/無効化 | 個別サーバーの切り替え |
| ツールパネル | 接続されたMCPサーバーの利用可能なツールを確認 |
...
### 完了した機能
- [x] **MCPサーバー統合** - 外部ツールとリソースの接続
- [x] **多言語サポート** - 11言語とRTLサポート
- [x] **クイックアクションカスタマイズ** - ボタンごとのプロンプト設定
- [x] **Obsidianプラグイン管理ツール** - AIを通じたプラグイン管理
